...
<div class="wrapper">
    ...
    <main class="main">
        <div class="content border-secondary">
            ...
            <div id="carouselExampleIndicators" class="carousel slide car_sli" data-ride="carousel">
            ...
            <div class="container flex-column sticky-top">
                ...
                <form class="form ">
                    <p>
                        <a class="btn btn-secondary LinkForm sticky-top " data-toggle="collapse"
                           id="linkCollapseMenu_1"
                           href="#navbarsExampleDefault_1" role="button"
                    ...
                    <div class="form-row collapse d-lg-block" id="navbarsExampleDefault_1">
                        ...
                        <button type="submit" class="btn btn-secondary m-2 ">Sign in</button>
                    </div>
                </form>
            </div>
        </div>
